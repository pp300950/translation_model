...
def translate_sentence(source_sentence, direction, translation_dict, reverse_translation_dict, reverse_translation_dict_en_th):
    ...
    if direction == 'zh-th':
        ...
        raise ValueError("Invalid direction. Use 'zh-th' for Chinese to Thai, 'th-zh' for Thai to Chinese, or 'th-en' for Thai to English.")
...
if __name__ == "__main__":
    ...
    direction = input("Enter translation direction (zh-th for Chinese to Thai, th-zh for Thai to Chinese, th-en for Thai to English): ")
